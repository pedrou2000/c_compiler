...
COMPILER_DIR=$(SRC_DIR)/compiler_main
...
################### COMPILER GENERATION ###################
###########################################################
compiler: $(SRC_DIR)/compiler

$(SRC_DIR)/compiler: $(COMPILER_DIR)/y.tab.o $(COMPILER_DIR)/lex.yy.o $(COMPILER_DIR)/symbols_table.o $(COMPILER_DIR)/generacion.o $(COMPILER_DIR)/alfa.o
	$(CC) $(CFLAGS) $^ -o $@
...
funciones:
	$(SRC_DIR)/compiler $(ALFA_BASIC_DIR)/funciones.alfa $(ASM_BASIC_DIR)/funciones.asm
...
condicionales:
	$(SRC_DIR)/compiler $(ALFA_BASIC_DIR)/condicionales.alfa $(ASM_BASIC_DIR)/condicionales.asm
...
fibonacci:
	$(SRC_DIR)/compiler $(ALFA_BASIC_DIR)/fibonacci.alfa $(ASM_BASIC_DIR)/fibonacci.asm
...
factorial:
	$(SRC_DIR)/compiler $(ALFA_BASIC_DIR)/factorial.alfa $(ASM_BASIC_DIR)/factorial.asm
...
funciones_vectores:
	$(SRC_DIR)/compiler $(ALFA_BASIC_DIR)/funciones_vectores.alfa $(ASM_BASIC_DIR)/funciones_vectores.asm
...
guion:
	$(SRC_DIR)/compiler $(ALFA_BASIC_DIR)/guion.alfa $(ASM_BASIC_DIR)/guion.asm
...
arithmetic:
	$(SRC_DIR)/compiler $(ALFA_BASIC_DIR)/arithmetic.alfa $(ASM_BASIC_DIR)/arithmetic.asm
...
logic:
	$(SRC_DIR)/compiler $(ALFA_BASIC_DIR)/logic.alfa $(ASM_BASIC_DIR)/logic.asm
...
ex1:
	$(SRC_DIR)/compiler $(ALFA_EXTRA_DIR)/ex1.alfa $(ASM_EXTRA_DIR)/ex1.asm
...
ex2:
	$(SRC_DIR)/compiler $(ALFA_EXTRA_DIR)/ex2.alfa $(ASM_EXTRA_DIR)/ex2.asm
...
ex3:
	$(SRC_DIR)/compiler $(ALFA_EXTRA_DIR)/ex3.alfa $(ASM_EXTRA_DIR)/ex3.asm
...
ex4:
	$(SRC_DIR)/compiler $(ALFA_EXTRA_DIR)/ex4.alfa $(ASM_EXTRA_DIR)/ex4.asm
...
ex5:
	$(SRC_DIR)/compiler $(ALFA_EXTRA_DIR)/ex5.alfa $(ASM_EXTRA_DIR)/ex5.asm
...
ex6:
	$(SRC_DIR)/compiler $(ALFA_EXTRA_DIR)/ex6.alfa $(ASM_EXTRA_DIR)/ex6.asm
...
ex7:
	$(SRC_DIR)/compiler $(ALFA_EXTRA_DIR)/ex7.alfa $(ASM_EXTRA_DIR)/ex7.asm
...
ex8:
	$(SRC_DIR)/compiler $(ALFA_EXTRA_DIR)/ex8.alfa $(ASM_EXTRA_DIR)/ex8.asm
...
ex9:
	$(SRC_DIR)/compiler $(ALFA_EXTRA_DIR)/ex9.alfa $(ASM_EXTRA_DIR)/ex9.asm
...
ex10:
	$(SRC_DIR)/compiler $(ALFA_EXTRA_DIR)/ex10.alfa $(ASM_EXTRA_DIR)/ex10.asm
...
ex11:
	$(SRC_DIR)/compiler $(ALFA_EXTRA_DIR)/ex11.alfa $(ASM_EXTRA_DIR)/ex11.asm
...
semantic_error1:
	$(SRC_DIR)/compiler $(ALFA_ERROR_DIR)/semantic_error1.alfa $(ASM_ERROR_DIR)/semantic_error1.asm

semantic_error2:
	$(SRC_DIR)/compiler $(ALFA_ERROR_DIR)/semantic_error2.alfa $(ASM_ERROR_DIR)/semantic_error2.asm

semantic_error3:
	$(SRC_DIR)/compiler $(ALFA_ERROR_DIR)/semantic_error3.alfa $(ASM_ERROR_DIR)/semantic_error3.asm

semantic_error4:
	$(SRC_DIR)/compiler $(ALFA_ERROR_DIR)/semantic_error4.alfa $(ASM_ERROR_DIR)/semantic_error4.asm

semantic_error5:
	$(SRC_DIR)/compiler $(ALFA_ERROR_DIR)/semantic_error5.alfa $(ASM_ERROR_DIR)/semantic_error5.asm

semantic_error6:
	$(SRC_DIR)/compiler $(ALFA_ERROR_DIR)/semantic_error6.alfa $(ASM_ERROR_DIR)/semantic_error6.asm

semantic_error7:
	$(SRC_DIR)/compiler $(ALFA_ERROR_DIR)/semantic_error7.alfa $(ASM_ERROR_DIR)/semantic_error7.asm

semantic_error8:
	$(SRC_DIR)/compiler $(ALFA_ERROR_DIR)/semantic_error8.alfa $(ASM_ERROR_DIR)/semantic_error8.asm

semantic_error9:
	$(SRC_DIR)/compiler $(ALFA_ERROR_DIR)/semantic_error9.alfa $(ASM_ERROR_DIR)/semantic_error9.asm

semantic_error10:
	$(SRC_DIR)/compiler $(ALFA_ERROR_DIR)/semantic_error10.alfa $(ASM_ERROR_DIR)/semantic_error10.asm

semantic_error11:
	$(SRC_DIR)/compiler $(ALFA_ERROR_DIR)/semantic_error11.alfa $(ASM_ERROR_DIR)/semantic_error11.asm

semantic_error12:
	$(SRC_DIR)/compiler $(ALFA_ERROR_DIR)/semantic_error12.alfa $(ASM_ERROR_DIR)/semantic_error12.asm

semantic_error13:
	$(SRC_DIR)/compiler $(ALFA_ERROR_DIR)/semantic_error13.alfa $(ASM_ERROR_DIR)/semantic_error13.asm

semantic_error14:
	$(SRC_DIR)/compiler $(ALFA_ERROR_DIR)/semantic_error14.alfa $(ASM_ERROR_DIR)/semantic_error14.asm

semantic_error15:
	$(SRC_DIR)/compiler $(ALFA_ERROR_DIR)/semantic_error15.alfa $(ASM_ERROR_DIR)/semantic_error15.asm

semantic_error16:
	$(SRC_DIR)/compiler $(ALFA_ERROR_DIR)/semantic_error16.alfa $(ASM_ERROR_DIR)/semantic_error16.asm

runtime_error_div_by_0:
	$(SRC_DIR)/compiler $(ALFA_ERROR_DIR)/runtime_error_div_by_0.alfa $(ASM_ERROR_DIR)/runtime_error_div_by_0.asm

runtime_error_out_of_index_vector:
	$(SRC_DIR)/compiler $(ALFA_ERROR_DIR)/runtime_error_out_of_index_vector.alfa $(ASM_ERROR_DIR)/runtime_error_out_of_index_vector.asm
...
clean_but_compiler:
	...
	rm -rf output_sin_1.txt output_sin_2.txt output_sin_3.txt output_sin_4.txt output_sin_5.txt *.gch
	rm -rf $(COMPILER_DIR)/y.output $(COMPILER_DIR)/y.tab.c $(COMPILER_DIR)/y.tab.h $(COMPILER_DIR)/lex.yy.c

clean_compiler: 
	rm -rf $(SRC_DIR)/compiler 

clean: clean_but_compiler clean_compiler
...
clean_all_but_compiler: clean_but_compiler clean_output
